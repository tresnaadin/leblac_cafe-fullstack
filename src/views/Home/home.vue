          ...
          <div class="icon-search">
              <div>
                  ...
                  <b-modal id="bv-modal-example" hide-footer >
                    ...
                    <b-button class="mt-3" variant="primary" block @click="searching()">Search</b-button>
                  </b-modal>
            </div>
          </div>
        </div>
         ...
         <div class="sidebar">
          <div class="sidebar-action">
            <div class="icon-menus"> 
                <img src="@/assets/fork.png"> <span>Menu</span>
            </div>
            ...
            v-on:click= "addCart(data)"> 
              ...
              footer-border-variant="dark">
                  ...
                  <div class="modal-body">
                    ...
                    <h5 style="margin-top:18px;">Category</h5>
                    <div id="input4">
                       <input v-model="update.category" type="text" class="form-control" placeholder="1. Drink - 2. Food - 3. Fast Food">
                  </div>
              </div>
              </b-modal> 
...
export default {
  ...
  methods: {
    ...
    searching(){
        ...
        axios.get(`http://localhost:8000/product/search?name=${this.search}`)
        .then(res => {
        this.product = res.data
      }).catch ((err) => {
        console.log(err)
    ...
    // searchPrice(){
    //     axios.get('http://localhost:4321/product/search?price=')
    //     .then(res => {
    //     this.product = res.data
    //   }).catch ((err) => {
    //     console.log(err)
